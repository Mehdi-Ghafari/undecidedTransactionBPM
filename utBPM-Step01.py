...
# region Function createFileOUT
def createFileOUT():
    print('First')
    vfnEN = 'temp\\' + lastFile('\EN')
    print(vfnEN)
    vfnENTRAN = 'temp\\' + lastFile('\EN TARAKONESH')
    print(vfnENTRAN)
# endregion Function createFileOUT
...
def lastFile(fn):
    ...
    for fn in filenames:
        ...
        with open('temp\\' + fn, "wb") as file:
            ...
            ftps.retrbinary(f"RETR {fn}", file.write)
